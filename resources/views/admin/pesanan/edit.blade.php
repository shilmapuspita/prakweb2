...
<form method="POST" action="{{ url('admin/pesanan/update/'. $pes->id) }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
        <input id="tanggal" name="tanggal" value="{{ $pes->tanggal }}" type="date" class="form-control" spellcheck="false" data-ms-editor="true">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
        <input id="email" name="email" value="{{ $pes->email }}" type="text" class="form-control" spellcheck="false" data-ms-editor="true">
        </div>
    </div>
    <div class="form-group row">
